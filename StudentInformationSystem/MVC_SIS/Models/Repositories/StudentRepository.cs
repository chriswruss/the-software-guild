...
namespace Exercises.Models.Repositories
{
    public class StudentRepository
    {
        ...
        // Default address contains values that shouldn't ever be input by
        // an actual user. This address is used when adding a student.
        private static Address _defaultAddress = new Address() {
            AddressId = 0,
            Street1 = "NOT ON FILE",
            City = "NOT ON FILE",
            State = new State() {
        ...
        public static void Add(Student student)
        {
            ...
            SaveAddress(student.StudentId, _defaultAddress);
        }
